...
function play(userChoice) {
    ...
    if (result === '勝ち！') {
        document.getElementById('next').textContent = 'クリストファーを捕まえる';
        document.getElementById('next').href = '/html/janken_chris.html';
    } else if (result === '負け！') {
        document.getElementById('next').textContent = 'もう一度初めから';
        document.getElementById('next').href = '/html/janken_tpl.html';
    } else {
        document.getElementById('next').textContent = 'もう一度初めから';
        document.getElementById('next').href = '/html/janken_tpl.html';
    }
